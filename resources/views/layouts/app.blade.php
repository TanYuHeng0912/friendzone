    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/home') }}">
                ...
                Friend Zone (Click here to match!)
            </a>
...
<li class="nav-item">
    <a class="nav-link" href="{{ route('chat.index') }}">
        ...
        @if($unreadChatsCount > 0)
            <span class="badge badge-danger ml-1">{{ $unreadChatsCount }}</span>
        @endif
    </a>
</li>
<!-- Add this to the navbar section in app.blade.php, after the existing nav items and before the matches link -->
