                    ...
                    <form method='post' action="{{ route('profile.updateSettings') }}">
                        ...
                        <div class="form-group row">
                            <label for="search_tag"
                                   class="col-md-4 col-form-label text-md-right">{{ __('I am looking for people who interest to') }}</label>
                        <div class="col-md-6">
                            <label for="search_tag1"></label>
                            <select class="form-control" id="search_tag1" name="search_tag1">
                            <option value="{{ $userSettings->search_tag1 }}">{{ $userSettings->search_tag1 }}</option>
                        ...
                        <div class="col-md-6">
                            <label for="search_tag2"></label>
                            <select class="form-control" id="search_tag2" name="search_tag2">
                            <option value="{{ $userSettings->search_tag2 }}">{{ $userSettings->search_tag2 }}</option>
                            <option value="Movie ">Movie</option> 
                            <option value="Travelling">Travelling</option> 
                            <option value="Art">Art</option> 
                            <option value="Sport">Sport</option> 
                        ...
                        <div class="col-md-6">
                            <label for="search_tag3"></label>
                            <select class="form-control" id="search_tag3" name="search_tag3">
                            <option value="{{ $userSettings->search_tag3 }}">{{ $userSettings->search_tag3 }}</option>
                            <option value="Movie ">Movie</option> 
                            <option value="Travelling">Travelling</option> 
                            <option value="Art">Art</option> 
                            <option value="Sport">Sport</option> 
